...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'change-me-please-change-this-very-long-default-key-for-development-only-2026',
)
...
CORS_ALLOWED_ORIGINS = [
    origin.strip() for origin in os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://localhost:8000').split(',') if origin.strip()
]
